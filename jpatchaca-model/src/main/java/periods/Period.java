...
public class Period {
	...
	private Interval getInterval() {
		DateTime startTime = new DateTime(startTime().getTime());
		DateTime endTime = new DateTime(endTime().getTime());

		return new Interval(startTime.withSecondOfMinute(0).withMillisOfSecond(0), endTime.withSecondOfMinute(0).withMillisOfSecond(0));
	}
