...
public class JiraMock implements Jira {
	...
	private Map<String, Integer> worklogsByKey = new HashMap<String, Integer>();
	...
	@Override
	public void newWorklog(String issueId, Calendar startDate, int timeSpent) {
		worklogsByKey.put(issueId, timeSpent);
	}

	public Integer timeLoggedFor(String key) {
