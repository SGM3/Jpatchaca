...
public final class PatchacaTasksOperatorUsingBusinessLayer implements
	...
	public long getTimeSpentInMinutes(final String taskName,
		...
		return taskByName(taskName).periodAt(periodIndex).totalMilliseconds();
	}
	...
	public void startTaskHalfAnHourAgo(final String taskName) {
		startTaskDelegate.starTask(new StartTaskData(new TaskData(
				new NonEmptyString(taskName)),
				(int) (DateUtils.MILLIS_PER_MINUTE * 30)));
	}
