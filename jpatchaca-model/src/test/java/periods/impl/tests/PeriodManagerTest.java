...
public class PeriodManagerTest {
	...
	public void testTotalTime() {
		manager.addPeriod(new Period(new Date(0), new Date(60000)));
		manager.addPeriod(new Period(new Date(60000), new Date(1200000)));
		assertEquals(Long.valueOf(1200000L), manager.totalMilliseconds());
	}
